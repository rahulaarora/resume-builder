...
export default function Home({ fileChangedHandler, submitHandler, changeHandler }) {
  useEffect(() => {
  ...
  return (
    <>
      <main className="m-4 md:m-20">
        <ProfileForm fileChangedHandler={fileChangedHandler} submitHandler={submitHandler} changeHandler={changeHandler} />
      </main>
    </>
  );
}
